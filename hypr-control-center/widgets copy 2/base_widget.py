...
- Smooth dragging (fixed anchor issue)
- Position persistence via widgets.json
- Always stays below windows
"""
...
# Layer shell (loaded via LD_PRELOAD in start-widgets.sh)
    ...
    def __init__(self, widget_id):
        ...
        if HAS_LAYER_SHELL and Gtk4LayerShell:
            try:
                ...
                # CRITICAL: Set anchors to TOP-LEFT only for positioning
                # This allows the widget to be positioned anywhere on screen
