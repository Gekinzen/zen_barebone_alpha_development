...
/*
 * ZenVersion v7.0.0-beta.1-hf98 — single source of truth for the shell version
 *
 * v7 RELEASE NOTES
 * ────────────────
...
Singleton {
    ...
    readonly property string version:        "v7.0.0-beta.1-hf98"
    ...
    readonly property string releaseDate:    "2026-06-30"
