        ...
        HMRow {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    color: saveMa.containsMouse ? ThemeService.alpha(ThemeService.green, 0.2) : LookService.surfaceColor(ThemeService.bg2, 0.5)
                    border.width: 1; border.color: ThemeService.alpha(ThemeService.green, 0.3)
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         id: saveL; anchors.centerIn: parent; text: "\udb80\udd93  Save"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 12; color: ThemeService.green }
                ...
                Rectangle {
                    ...
                    color: overMa.containsMouse ? ThemeService.alpha(ThemeService.blue, 0.2) : LookService.surfaceColor(ThemeService.bg2, 0.5)
                    border.width: 1; border.color: ThemeService.alpha(ThemeService.blue, 0.2)
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         id: overL; anchors.centerIn: parent; text: "\udb81\udc50  Overwrite"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 12; color: ThemeService.blue }
        ...
        HMRow {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    color: impMa.containsMouse ? ThemeService.alpha(ThemeService.purple, 0.2) : LookService.surfaceColor(ThemeService.bg2, 0.5)
                    border.width: 1; border.color: ThemeService.alpha(ThemeService.purple, 0.2)
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         id: impL; anchors.centerIn: parent; text: "\udb83\udfaa  Import"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 12; color: ThemeService.purple }
                ...
                Rectangle {
                    ...
                    color: expMa.containsMouse ? ThemeService.alpha(ThemeService.orange, 0.2) : LookService.surfaceColor(ThemeService.bg2, 0.5)
                    border.width: 1; border.color: ThemeService.alpha(ThemeService.orange, 0.2)
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         id: expL; anchors.centerIn: parent; text: "\udb83\udfab  Export"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 12; color: ThemeService.orange }
            ...
            HMRow {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        color: actMa.containsMouse ? ThemeService.alpha(ThemeService.blue, 0.2) : LookService.surfaceColor(ThemeService.bg2, 0.4)
                        border.width: 1; border.color: ThemeService.alpha(ThemeService.blue, 0.15)
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             id: actL; anchors.centerIn: parent; text: "Activate"; font.family: Theme.fontFamily; font.pixelSize: 10; color: ThemeService.blue }
                    ...
                    Rectangle {
                        ...
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             id: delL; anchors.centerIn: parent; text: "\udb80\udc6c"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 12; color: ThemeService.red }
