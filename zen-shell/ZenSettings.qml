...
Rectangle {
    ...
    */
    ...
    readonly property var navItems: [
        ...
        // v7.0.0-beta.1-hf99l — Shell Look (Classic / Zen / Glass) selector
        { id: "shelllook",   label: "Shell Look",         icon: "\udb81\udd9c",      kanji: "装い", romaji: "Yosooi" },
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            color: LookService.surfaceColor(ThemeService.bg1, 0.85)
            ...
            RowLayout {
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        // v8.0.0-alpha-hf113: on MOVEMENT, not on press. A bare
                        // `onPressed` meant one click on the header broke the
                        // centering and dropped the window at 0,0.
                        onPositionChanged: if (drag.active) root.hasBeenDragged = true
                    }
                }
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        radius: 6
                        color: LookService.surfaceColor(ThemeService.bg2, 0.4)
        ...
        Rectangle {
            ...
            Item {
                ...
                StackLayout {
                    ...
                    // v7.0.0-beta.1-hf99l — Shell Look selector
                    ShellLookPage { }         // index 31
                }
            }
        }
    }
