...
Rectangle {
    ...
    // v8.0.0-alpha-hf149 — THIS is the notification popup that actually shows
    // (shell.qml instantiates NotificationListPanel, not ZenNotificationCenter).
    // hf148 frosted the wrong file; this is the right one. Frosted white on Glass+.
    color: LookService.bodyColor(LookService.surfaceColor(ThemeService.bg0, 0.98))
    radius: 10
