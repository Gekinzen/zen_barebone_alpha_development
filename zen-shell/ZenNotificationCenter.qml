...
Rectangle {
    ...
    // v8.0.0-alpha-hf148 — the notification centre follows the look like the
    // dock/bars: frosted white body + no border on Glass+, its own value otherwise.
    color: LookService.bodyColor(Qt.rgba(ThemeService.bg0.r, ThemeService.bg0.g, ThemeService.bg0.b, PanelState.notificationOpacity))
    border.width: LookService.bodyBorderWidth(1)
    border.color: LookService.bodyBorderColor(ThemeService.alpha(ThemeService.fg, 0.12))
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Text {
                    style: LookService.isClear ? Text.Outline : Text.Normal
                    styleColor: LookService.clearTextOutline
                     anchors.centerIn: parent; text: "\uf104"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 14; color: ThemeService.grey0 }
        ...
        RowLayout {
            ...
            Repeater {
                ...
                Text {
                    style: LookService.isClear ? Text.Outline : Text.Normal
                    styleColor: LookService.clearTextOutline
                     required property string modelData; Layout.fillWidth: true; text: modelData; font.family: Theme.fontFamily; font.pixelSize: 10; font.weight: Font.DemiBold; color: ThemeService.grey1; horizontalAlignment: Text.AlignHCenter }
            }
        }
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             anchors.centerIn: parent; text: "⤢"; font.pixelSize: 12; color: expandMa.containsMouse ? ThemeService.blue : ThemeService.grey1 }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             anchors.centerIn: parent; text: "✕"; font.pixelSize: 10; color: ThemeService.grey1 }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        color: isSelected
                               ...
                               : existNoteMa.containsMouse
                                 ...
                                 : LookService.surfaceColor(ThemeService.bg1, 0.4)
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                Text {
                                    style: LookService.isClear ? Text.Outline : Text.Normal
                                    styleColor: LookService.clearTextOutline
                                     anchors.centerIn: parent; text: "✓"; font.pixelSize: 9; color: ThemeService.green }
                                MouseArea {
                ...
                Rectangle {
                    ...
                    color: LookService.surfaceColor(ThemeService.bg0, 0.8)
                ...
                RowLayout {
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "🔔"; font.pixelSize: 11; color: ThemeService.grey1; visible: calendarNoteTime.text.length > 0 }
                    Item { Layout.fillWidth: true }
                    ...
                    Rectangle {
                        ...
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             anchors.centerIn: parent; text: root._editingNoteId ? "Update" : "Save"; font.family: Theme.fontFamily; font.pixelSize: 11; font.weight: Font.DemiBold; color: ThemeService.fg }
                        MouseArea {
        ...
        Rectangle {
            ...
            Text {
                style: LookService.isClear ? Text.Outline : Text.Normal
                styleColor: LookService.clearTextOutline
                 anchors.centerIn: parent; text: "↩ Today"; font.family: Theme.fontFamily; font.pixelSize: 10; color: ThemeService.blue }
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    color: {
                        ...
                        return sysActionMa.containsMouse ? ThemeService.alpha(ThemeService.fg, 0.08) : LookService.surfaceColor(ThemeService.bg1, 0.4)
                    }
                    border.width: 1
                ...
                delegate: Rectangle {
                    ...
                    RowLayout {
                        ...
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             text: modelData.icon; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 13; color: ThemeService[modelData.color] || ThemeService.grey0 }
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             text: modelData.label; font.family: Theme.fontFamily; font.pixelSize: 11; font.weight: Font.DemiBold; color: ThemeService.fg }
                    }
