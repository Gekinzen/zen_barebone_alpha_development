...
Rectangle {
    ...
    PopupWindow {
        ...
        Rectangle {
            anchors.fill: parent
            radius: 14
            // v8.0.0-alpha-hf148 — calendar popup follows the look too.
            color: LookService.bodyColor(Qt.rgba(Theme.bg0.r, Theme.bg0.g, Theme.bg0.b, 0.97))
            border.width: LookService.bodyBorderWidth(1)
            border.color: LookService.bodyBorderColor(Theme.alpha(Theme.fg, 0.12))
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             anchors.centerIn: parent; text: "\uf104"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 14; color: Theme.grey0 }
                        MouseArea {
