...
ScrollView {
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Text {
                ...
                styleColor: LookService.clearTextOutline
                 text: "Displays"; font.family: Theme.fontFamily; font.pixelSize: 22; font.weight: Font.Bold; color: ThemeService.fg }
            Text {
                style: LookService.isClear ? Text.Outline : Text.Normal
                styleColor: LookService.clearTextOutline
                 text: "Drag monitors to reposition • click to select"; font.family: Theme.fontFamily; font.pixelSize: 12; color: ThemeService.grey1 }
        }
        ...
        Rectangle {
            ...
            color: LookService.surfaceColor(ThemeService.bg1, 0.35)
            ...
            RowLayout {
                ...
                Text {
                    style: LookService.isClear ? Text.Outline : Text.Normal
                    styleColor: LookService.clearTextOutline
                     text: "Snap:"; font.family: Theme.fontFamily; font.pixelSize: 11; font.weight: Font.DemiBold; color: ThemeService.grey0 }
                Repeater {
                    model: [
                        { dir: "left",  icon: "\uf060" },
                        { dir: "right", icon: "\uf061" },
                    ...
                    delegate: Rectangle {
                        ...
                        color: pBtn.containsMouse ? ThemeService.alpha(ThemeService.blue, 0.16) : LookService.surfaceColor(ThemeService.bg2, 0.4)
                        border.width: 1; border.color: ThemeService.alpha(ThemeService.fg, 0.08)
                        RowLayout {
                            ...
                            Text {
                                style: LookService.isClear ? Text.Outline : Text.Normal
                                styleColor: LookService.clearTextOutline
                                 text: modelData.icon; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 10; color: ThemeService.fg }
                            Text {
                                style: LookService.isClear ? Text.Outline : Text.Normal
                                styleColor: LookService.clearTextOutline
                                 text: modelData.dir.charAt(0).toUpperCase() + modelData.dir.slice(1); font.family: Theme.fontFamily; font.pixelSize: 10; color: ThemeService.fg }
                        }
                ...
                Rectangle {
                    ...
                    color: nwgB.containsMouse ? ThemeService.alpha(ThemeService.purple, 0.16) : LookService.surfaceColor(ThemeService.bg2, 0.3)
                    ...
                    RowLayout { id: nwgR; anchors.centerIn: parent; spacing: 4
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             text: "\uf26c"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 10; color: ThemeService.purple }
                        Text {
                            style: LookService.isClear ? Text.Outline : Text.Normal
                            styleColor: LookService.clearTextOutline
                             text: "nwg-displays"; font.family: Theme.fontFamily; font.pixelSize: 10; color: ThemeService.purple }
                    }
        ...
        Text {
            style: LookService.isClear ? Text.Outline : Text.Normal
            styleColor: LookService.clearTextOutline
             visible: root.applyStatus.length > 0; text: root.applyStatus; font.family: Theme.fontFamily; font.pixelSize: 11; color: root.applyStatus.startsWith("✓") ? ThemeService.green : ThemeService.yellow; Layout.alignment: Qt.AlignHCenter }
        ...
        Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 80; radius: 12; color: LookService.surfaceColor(ThemeService.bg1, 0.4); visible: root.monitors.length === 0
            Text {
                style: LookService.isClear ? Text.Outline : Text.Normal
                styleColor: LookService.clearTextOutline
                 anchors.centerIn: parent; text: "No monitors detected."; font.family: Theme.fontFamily; font.pixelSize: 13; color: ThemeService.grey1 }
        }
                        ...
                        Rectangle { Layout.preferredWidth: applyR.implicitWidth + 32; Layout.preferredHeight: 36; radius: 8
                            ...
                            RowLayout { id: applyR; anchors.centerIn: parent; spacing: 6
                                Text {
                                    style: LookService.isClear ? Text.Outline : Text.Normal
                                    styleColor: LookService.clearTextOutline
                                     text: "\uf00c"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 11; color: ThemeService.blue }
                                Text {
                                    style: LookService.isClear ? Text.Outline : Text.Normal
                                    styleColor: LookService.clearTextOutline
                                     text: "Apply " + modelData.name; font.family: Theme.fontFamily; font.pixelSize: 12; font.weight: Font.DemiBold; color: ThemeService.blue }
                            }
