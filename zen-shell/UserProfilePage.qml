            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "User"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "OS"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "Kernel"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "Uptime"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "CPU"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "WM"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "Shell"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "Version"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
                    ...
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                         text: "Theme"; color: ThemeService.blue; font.family: Theme.fontFamily; font.pixelSize: 12; font.bold: true }
                    Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        Layout.fillWidth: true
