        ...
        ColumnLayout {
            ...
            Text {
                ...
                styleColor: LookService.clearTextOutline
                 text: "Battery, Power & GPU"; font.family: Theme.fontFamily; font.pixelSize: 22; font.weight: Font.Bold; color: ThemeService.fg }
            Text {
                style: LookService.isClear ? Text.Outline : Text.Normal
                styleColor: LookService.clearTextOutline
                 text: "Battery, notifications, power profile, GPU switcher, lid behavior"
