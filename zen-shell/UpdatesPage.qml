    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                radius: 12
                color: LookService.surfaceColor(ThemeService.bg1, 0.6)
            ...
            SettingsSection {
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            ...
                            color: snapNowBtn.hovered
                                ? LookService.surfaceColor(ThemeService.bg2, 0.9)
                                : LookService.surfaceColor(ThemeService.bg2, 0.6)
                ...
                Rectangle {
                    ...
                    radius: 10
                    color: LookService.surfaceColor(ThemeService.bg2, 0.3)
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color: rowMA.containsMouse
                            ? LookService.surfaceColor(ThemeService.bg2, 0.8)
                            ...
                            Button {
                                ...
                                background: Rectangle {
                                    ...
                                    color: pinBtn.hovered
                                        ...
                                        : LookService.surfaceColor(ThemeService.bg1, 0.7)
                                    border.color: ThemeService.alpha(ThemeService.fg, 0.1)
                                    border.width: 1
                                }
                                contentItem: Text {
            ...
            Rectangle {
                ...
                color: {
                    switch (ZenUpdateService.lastUpdateStatus) {
                        ...
                        default:        return LookService.surfaceColor(ThemeService.bg2, 0.5)
                    }
                }
                border.color: {
                    switch (ZenUpdateService.lastUpdateStatus) {
        ...
        contentItem: ColumnLayout {
            ...
            RowLayout {
                ...
                Button {
                    ...
                    background: Rectangle {
                        radius: 8
                        color: LookService.surfaceColor(ThemeService.bg2, 0.7)
                        border.color: ThemeService.alpha(ThemeService.fg, 0.1)
                        border.width: 1
                    }
                    contentItem: Text {
                ...
                Button {
                    ...
                    contentItem: Text {
                        style: LookService.isClear ? Text.Outline : Text.Normal
                        styleColor: LookService.clearTextOutline
                        text: parent.text; color: LookService.surfaceColor(ThemeService.bg0, 1.0)
