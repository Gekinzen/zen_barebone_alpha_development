...
ScrollView {
        ...
        HMSection {
            ...
            HMRow {
                ...
                ColorSwatch {
                    ...
                    onValueEdited: hex => DockState.overrideBgColor = "#" + hex.replace(/^#/, "").substring(0, 6)  // v8 colorfix
                }
            }
            ...
            HMRow {
                ...
                ColorSwatch {
                    ...
                    onValueEdited: hex => DockState.overrideBorderColor = "#" + hex.replace(/^#/, "").substring(0, 6)  // v8 colorfix
                }
            }
    ...
    function _moduleDescription(id) {
        switch (id) {
            ...
            case "controlcenter": return "Opens the Zen Control Center (same as SUPER+C)"
            case "weather":       return "Current conditions — same module as the bar"
            case "power":         return "Lock / suspend / logout / restart / shutdown"
