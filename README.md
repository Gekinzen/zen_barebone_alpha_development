...
**Current version: v6.16.4.11.2 "Kintsugi" (金継ぎ)** — stable
**Repo branch:** `main` (promoted 2026-04-24)
...
Live captures from v6.16.4.11.2 running on Hyprland 0.54 with the Kintsugi Dark theme.
...
### 🟢 Latest — v6.16.4.11.2 "Kintsugi" Release Showcase
...
## What v6.16.4.11.2 "Kintsugi" ships

This release closes out the v6.16.4 alpha cycle — eleven iterations of hardening the v4.1 panic-hotfix base. Named after the Japanese art of repairing broken pottery with gold: the seams aren't hidden, they're illuminated.
...
Full v4.x alpha cycle changelog: `CHANGELOG-v6.16.4.1.md` through `CHANGELOG-v6.16.4.11.2.md`.
...
├── CHANGELOG-v6.16.4.11.2.md   Detailed changelog for THIS release
...
| `~/.config/quickshell/zen-shell/panel-state.json` | Panel mode, bar layout, module zones |
