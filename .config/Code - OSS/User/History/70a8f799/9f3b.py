...
/* FORCE WHITE ICONS - NUCLEAR SPECIFICITY */
.sidebar-icon,
.force-white,
window .sidebar listboxrow image,
window .sidebar listbox row image,
listboxrow.sidebar-item image,
.sidebar list image {{
    color: {fg} !important;
...
/* Global icon forcing - HIGHEST PRIORITY */
image {{
    color: {fg} !important;
    -gtk-icon-palette: {fg} !important;
}}
...
/* ═══════════════════════════════════════════════════════════════ */
/* REST OF CSS - KEEPING ALL YOUR FEATURES                         */
/* ═══════════════════════════════════════════════════════════════ */
