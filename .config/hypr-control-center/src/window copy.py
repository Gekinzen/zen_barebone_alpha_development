...
from .pages.theming import build_theming_page  # ← ADD THIS IMPORT
...
"""
    ...
    def _build_ui(self):
        ...
        self.stack.add_named(build_theming_page(self), "theming")  # ← ADD THIS LINE
    ...
    def _build_sidebar(self) -> Gtk.Box:
        ...
        # ═══ NAVIGATION SECTIONS - THEMING ADDED TO DESKTOP ═══
        nav_sections = [
            ("DESKTOP", [
                ...
                ("Theming", "theming", "preferences-desktop-theme-symbolic"),  # ← ADD THIS LINE
