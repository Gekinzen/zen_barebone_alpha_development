...
#cpu:hover {
    ...
    color: @blue;
    box-shadow: inset 0 -2px 0 alpha(@blue, 0.6);
...
#memory:hover {
    ...
    color: @green;
    box-shadow: inset 0 -2px 0 alpha(@green, 0.6);
...
#temperature:hover {
    ...
    color: @orange;
    box-shadow: inset 0 -2px 0 alpha(@orange, 0.6);
...
#pulseaudio:hover {
    ...
    box-shadow: inset 0 -2px 0 alpha(@yellow, 0.6);
...
#network:active {
    box-shadow: inset 0 0 6px alpha(@fg, 0.25);
}
...
#custom-pacman:hover {
    ...
    color: #00fff7;
    box-shadow: inset 0 -2px 0 alpha(#00fff7, 0.6);
