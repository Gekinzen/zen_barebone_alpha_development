...
class DockWidget(Gtk.Window):
    ...
    def _setup_layer_shell(self):
        """
        Setup GTK4 Layer Shell with EXCLUSIVE ZONE.
        
        Unlike panel_widget.py which uses exclusive_zone(-1) to float,
        this dock uses auto_exclusive_zone so windows respect it.
        """
        ...
        if self.visibility == DockVisibility.ALWAYS:
            # EXCLUSIVE ZONE - windows won't overlap
            Gtk4LayerShell.set_layer(self, Gtk4LayerShell.Layer.TOP)
            Gtk4LayerShell.auto_exclusive_zone_enable(self)
            print("[Dock] 🔒 Exclusive zone: enabled (windows won't overlap)")
        else:
            # Non-exclusive for autohide/hidden
            Gtk4LayerShell.set_layer(self, Gtk4LayerShell.Layer.TOP)
            Gtk4LayerShell.set_exclusive_zone(self, -1)
            print("[Dock] 🔓 Non-exclusive zone (autohide/hidden mode)")
        ...
        if edge == DockPosition.BOTTOM:
            ...
            Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.BOTTOM, offset)
            if self.config.get("centered", True) and not self.config.get("stretch", False):
                # Don't anchor left/right → centers naturally
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.LEFT, False)
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.RIGHT, False)
            elif self.config.get("stretch", False):
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.LEFT, True)
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.RIGHT, True)
                m = self.config.get("dock_margin", 8)
                Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.LEFT, m)
                Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.RIGHT, m)
            
        elif edge == DockPosition.TOP:
            Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.TOP, True)
            Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.BOTTOM, False)
            Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.TOP, offset)
            if self.config.get("centered", True) and not self.config.get("stretch"):
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.LEFT, False)
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.RIGHT, False)
            elif self.config.get("stretch"):
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.LEFT, True)
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.RIGHT, True)
                m = self.config.get("dock_margin", 8)
                Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.LEFT, m)
            ...
            Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.LEFT, True)
            Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.RIGHT, False)
            Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.LEFT, offset)
            if self.config.get("centered", True) and not self.config.get("stretch"):
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.TOP, False)
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.BOTTOM, False)
            elif self.config.get("stretch"):
                ...
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.BOTTOM, True)
                m = self.config.get("dock_margin", 8)
                Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.TOP, m)
                Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.BOTTOM, m)
            
        elif edge == DockPosition.RIGHT:
            Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.RIGHT, True)
            Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.LEFT, False)
            Gtk4LayerShell.set_margin(self, Gtk4LayerShell.Edge.RIGHT, offset)
            if self.config.get("centered", True) and not self.config.get("stretch"):
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.TOP, False)
                Gtk4LayerShell.set_anchor(self, Gtk4LayerShell.Edge.BOTTOM, False)
            elif self.config.get("stretch"):
