...
echo ""
echo "    Zen Shell v6.11"
echo "    ─────────────────────────────────────────────────────"
echo ""
echo "    Quickshell-native desktop environment for Hyprland."
echo ""
echo "    This release:"
echo "      Desktop widgets redesign   Draggable + position save"
echo "      Widget color modes         Default / Theme / Custom"
echo "      Weather card               Boxed 7-day forecast"
echo "      System Monitor card        2x2 grid with usage bars"
echo "      Bar display target         All / Primary / specific monitor"
echo "      Screenshot enhanced        Flameshot display targeting"
echo "      Thunar thumbnails          tumbler + ffmpegthumbnailer"
echo "      Smart installer            Auto-backup, auto-apply modules"
echo ""
echo "    ─────────────────────────────────────────────────────"
echo ""
...
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║                                                               ║"
echo "║            🎉  ZEN SHELL v6.7.2 INSTALLED SUCCESSFULLY  🎉      ║"
echo "║                                                               ║"
echo "╚═══════════════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "  ── New in v6.7 ──"
echo "      Installer now offers to auto-install missing optional packages"
echo "      via paru / yay / pacman (press Y when prompted)"
echo "      Loud success banner showing exactly what landed where"
echo ""
echo "  ── New in v6.6 ──"
echo "      SwayNC notification theming (auto-syncs on theme change)"
echo "      Custom theme profiles (General → Theme Palette → Save)"
echo "      Bar Modules page — 13 clock, 11 workspace, 10 font presets"
echo ""
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  ✅  All done. Enjoy Zen Shell v6.7.2, pre."
echo "═══════════════════════════════════════════════════════════════"
echo ""
